...
# Windows consoles default to cp1252, which can't encode em dashes and other
# non-ASCII characters used in log messages elsewhere in this codebase.
...
# Static UI
# ---------------------------------------------------------------------------
_UI_DIR = os.path.join(os.path.dirname(__file__), "demo_ui")
if os.path.isdir(_UI_DIR):
    app.mount("/ui", StaticFiles(directory=_UI_DIR, html=True), name="demo_ui")
