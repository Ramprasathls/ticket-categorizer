...
def build_deterministic_llm(model: str = "gemini-flash-latest", seed: int = 42) -> ChatGoogleGenerativeAI:
    """
...
def build_creative_llm(model: str = "gemini-flash-latest", temperature: float = 0.7) -> ChatGoogleGenerativeAI:
    """
