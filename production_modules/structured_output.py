...
_DEFAULT_MODEL = os.getenv("DEFAULT_MODEL", "gemini-flash-latest")
...
def _extract_text(content) -> str:
    """
    ChatGoogleGenerativeAI returns response.content as a list of content
    blocks (e.g. [{"type": "text", "text": "..."}]) rather than a plain
    string like ChatOpenAI does. Normalize both shapes to a single string.
    """
